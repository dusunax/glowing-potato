...
const ANIMAL_TEMPLATES = {
  ...
  wildBoar: {
    name: 'Wild Boar',
    emoji: '🐗',
    sprite: ANIMAL_VISUALS.wildBoar,
    behavior: 'hostile',
    maxHp: 5,
    attack: 3,
    rarity: 3,
  ...
  stoneCrawler: {
    name: 'Stone Crawler',
    emoji: '🦂',
    sprite: ANIMAL_VISUALS.stoneCrawler,
    behavior: 'hostile',
    maxHp: 7,
    attack: 4,
    rarity: 4,
  ...
  rockCrawler: {
    name: 'Rock Crawler',
    emoji: '🪨',
    sprite: ANIMAL_VISUALS.rockCrawler,
    behavior: 'hostile',
    maxHp: 6,
    attack: 5,
    rarity: 4,
  ...
  skeleton: {
    name: 'Skeleton',
    emoji: '💀',
    sprite: ANIMAL_VISUALS.skeleton,
    behavior: 'hostile',
    maxHp: 12,
    attack: 7,
    rarity: 5,
  ...
  bloodSkeleton: {
    name: 'Blood Skeleton',
    emoji: '🩸',
    sprite: ANIMAL_VISUALS.bloodSkeleton,
    behavior: 'hostile',
    maxHp: 16,
    attack: 12,
    rarity: 5,
...
) as Record<string, AnimalTemplate>;
